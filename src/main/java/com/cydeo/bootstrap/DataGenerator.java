...
@Component
// we are keeping some fake date, use this Interface (coming from SB) for data generation, whenever we say 'run' fake data will be generated first of all
public class DataGenerator implements CommandLineRunner {
    //Dependency injection, generate constructor and always use Interface (HAS-A relationship)
    RoleService roleService;// -> we are asking for a Bean and inject it to DG
    UserService userService;// go to UserServiceImpl and annotate @Service
